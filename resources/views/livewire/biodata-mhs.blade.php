        ...
        <div class="p-5 h-full">
            ...
            <div class="flex flex-col xl:flex-row gap-5">
                ...
                <div class="w-full order-1 xl:order-2 xl:w-1/3">
                    ...
                    <a class="text-center mt-5 bg-primary hover:bg-sky-500 hover:font-semibold w-full p-2 rounded text-white gap-1 drop-shadow-md hidden xl:block" href="{{ route('edit-profile-mhs') }}">Edit Profile</a>
                </div>
                <a class="text-center bg-primary hover:bg-sky-500 hover:font-semibold w-full p-2 rounded text-white gap-1 drop-shadow-md order-3 xl:hidden" href="{{ route('edit-profile-mhs') }}">Edit Profile</a>
            </div>
        </div>
    </x-app-layout>
</div>
