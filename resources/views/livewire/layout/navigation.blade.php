        ...
        <aside id="sidebar"
            ...
            <ul class="mt-5 h-full flex flex-col justify-between">
                <div>
                    ...
                    <!-- History -->
                    <a href="{{ route('CreateRuangan') }}">
                        <li class="flex items-center h-14 px-5 hover:bg-secondary hover:text-black
                        {{ Route::is('CreateRuangan') ? 'bg-secondary text-black' : 'text-white' }}">
                            <div class="flex items-center gap-2">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
                                         class="bi bi-clock" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('CreateUjian') }}">
                        <li class="flex items-center h-14 px-5 hover:bg-secondary hover:text-black
                        {{ Route::is('CreateUjian') ? 'bg-secondary text-black' : 'text-white' }}">
                            <div class="flex items-center gap-2">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
                                         class="bi bi-clock" viewBox="0 0 16 16">
                    ...
                    <!-- History -->
                    <a href="{{ route('CreateTipeUjian') }}">
                        <li class="flex items-center h-14 px-5 hover:bg-secondary hover:text-black
                        {{ Route::is('CreateTipeUjian') ? 'bg-secondary text-black' : 'text-white' }}">
                            <div class="flex items-center gap-2">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
                                         class="bi bi-clock" viewBox="0 0 16 16">
