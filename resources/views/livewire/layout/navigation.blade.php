    ...
    @if($auth == "mhs")
        <aside id="sidebar"
            ...
            <div class="mt-5 w-60 h-fit flex flex-col items-center gap-2">
                <div class="w-28">
                    <img src="{{'https://online.unai.edu/mhs/'.$foto}}" alt="" width="150" height="200"  class="size-fit rounded-xl">
                </div>
            ...
            <ul class="mt-5 h-full flex flex-col justify-between">
                <div>
                    ...
                    <a href="{{ route('dashboard-mhs') }}">
                        <li class="flex items-center gap-2 h-14 px-5 hover:bg-secondary text-white {{ Route::is('dashboard-mhs') ? 'bg-secondary' : 'text-white' }}">
                    ...
                    <!-- Profile -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary text-white {{ Route::is('biodata-mhs') || Route::is('biodata-user')  ||  Route::is('edit-profile-mhs') ||  Route::is('edit-profile-user') || Route::is('change-password-mhs') || Route::is('change-password-user')  ? 'bg-secondary' : 'text-white' }}">
...
{{--                        </a>--}}
                    ...
                    <!-- Type Test -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary text-white {{ Route::is('e3-schedule-mhs') || Route::is('toefl-schedule-mhs') || Route::is('e3-schedule-user') || Route::is('toefl-schedule-user') ? 'bg-secondary' : 'text-white' }}">
                        <div class="flex items-center gap-2">
                            <div>
    ...
    @elseif($auth =='user')
        <aside id="sidebar"
            ...
            <div class="mt-5 w-60 h-fit flex flex-col items-center gap-2">
                <div class="w-28">
                    <img src="{{ asset('storage/' . $data->pasFoto) }}" alt="" width="150" height="200"
            ...
            <ul class="mt-5 h-full flex flex-col justify-between">
                <div>
                    ...
                    <!-- Profile -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  {{ Route::is('biodata-user')  ||  Route::is('edit-profile-user') || Route::is('change-password-user')  ? 'bg-secondary text-black' : 'text-white' }}">
                        <div class="flex items-center gap-2 w-fit">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
                    ...
                    <!-- Type Test -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  {{ Route::is('e3-schedule-user') || Route::is('toefl-schedule-user') ? 'bg-secondary text-black' : 'text-white' }}">
                        <div class="flex items-center gap-2">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
            ...
            <ul class="mt-5 h-full flex flex-col justify-between">
                <div>
                    ...
                    <a href="{{ route('dashboard-admin') }}">
                        <li class="flex items-center gap-2 h-14 px-5 hover:bg-secondary hover:text-black {{ Route::is('dashboard-admin') ? 'bg-secondary text-black' : 'text-white' }}">
                            <div class="flex items-center gap-2">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
                                         class="bi bi-grid" viewBox="0 0 16 16">
                    ...
                    <!-- Profile -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  {{ Route::is('biodata-admin')
  ||  Route::is('edit-profile-admin') || Route::is('change-password-admin')  ? 'bg-secondary text-black' : 'text-white' }}">
                    ...
                    <!-- Type Test -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  {{ Route::is('e3-schedule-admin')
 || Route::is('toefl-schedule-admin') ? 'bg-secondary text-black' : 'text-white' }}">
                    ...
                    <ul class="hidden" id="typeDropdown">
                        <!-- E3 -->
                        <a href="{{ route('e3-schedule-admin') }}">
                            <li class="flex items-center justify-between h-14 px-5 text-white hover:bg-secondary">
                                <div class="flex items-center gap-2 w-fit">
                                    <div class="w-6"></div>
                                    <p class="text-lg">E3</p>
                        ...
                        <!-- TOEFL -->
                        <a href="{{ route('toefl-schedule-admin') }}">
                            <li class="flex items-center justify-between h-14 px-5 text-white hover:bg-secondary">
                                <div class="flex items-center gap-2 w-fit">
                                    <div class="w-6"></div>
                                    <p class="text-lg">TOEFL</p>
                    ...
                    <a href="{{ route('history-admin') }}">
                        ...
                        {{ Route::is('history-admin') ? 'bg-secondary text-black' : 'text-white' }}">
                            <div class="flex items-center gap-2">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black"
                                         class="bi bi-clock" viewBox="0 0 16 16">
