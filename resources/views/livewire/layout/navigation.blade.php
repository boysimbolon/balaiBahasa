        ...
        <aside id="sidebar" class="bg-primary w-60 h-screen pt-20 flex flex-col fixed top-0 bottom-0 -left-60 transition duration-700 ease-in-out z-10 overflow-auto">
            ...
            <ul class="mt-5 h-full flex flex-col justify-between">
                <div>
                    ...
                    <!-- Profile -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  {{ Route::is('biodata-mhs') || Route::is('biodata-user')  ||  Route::is('edit-profile-mhs') ||  Route::is('edit-profile-user') || Route::is('change-password-mhs') || Route::is('change-password-user')  ? 'bg-secondary text-black' : 'text-white' }}">
