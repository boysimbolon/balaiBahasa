                        ...
                        <div class="grid gap-5">
                            ...
                            <div class="mb-2">
                                <div class="flex flex-col md:flex-row justify-between items-center">
                                    ...
                                    <input type="password" wire:model="" name="old_password" id="old_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/2 p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Password Lama" required autofocus>
                                </div>
                            ...
                            <div class="mb-2">
                                <div class="flex flex-col md:flex-row justify-between items-center">
                                    ...
                                    <input type="password" wire:model="" name="new_password" id="new_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/2 p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Password Baru" required autofocus>
                                </div>
                                <x-input-error :messages="$errors->get('')" class="mt-2"/>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="flex flex-col md:flex-row justify-between items-center">
                                    ...
                                    <input type="password" wire:model="" name="confirm_new_password" id="confirm_new_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-1/2 p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Konfirmasi Password Baru" required autofocus>
                                </div>
                                <x-input-error :messages="$errors->get('')" class="mt-2"/>
                            </div>
