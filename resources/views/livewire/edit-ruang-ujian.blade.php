...
<x-app-layout>
    ...
    <div class="flex items-center justify-between">
        <h4 class="page-title text-2xl font-medium mb-0">Edit Ruangan</h4>
                            ...
                            <div class="grid gap-5">
                                ...
                                <div class="mb-2">
                                    <div class="flex flex-col md:flex-row justify-between items-center">
                                        ...
                                        <button type="submit" class="waves-effect waves-light w-full md:w-1/2 md:hidden rounded-xl btn btn-primary text-center">Update Ruangan</button>
                                    </div>
                                </div>
                            </div>
                        </form>
