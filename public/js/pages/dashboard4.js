$(function () {
    ...
    $('.sparkline-1').sparkline('html',
        {type: 'line', height: '2.5em', width: '5em'});
  
var options = {
        series: [{
            name: "Profit",
            data: [60, 45, 70, 65, 95, 60, 70, 55, 60, 39]
        }],
        chart: {
            foreColor:"#bac0c7",
          height: 350,
      ...
      var options = {
        ...
        var chart = new ApexCharts(document.querySelector("#activities"), options);
        chart.render();
        ...
        var option = {
            // Add title
                ...
                legend: {
                    ...
                    y: 'bottom',
                    x: 'left',
                    data: ['Successful Deals', 'Failed Deals']
                },
                ...
                series: [{
                    ...
                    center: ['50%', '45.5%'],
                    data: [
                        {value: 46, name: 'Successful Deals'},
                        {value: 65, name: 'Failed Deals'},
                    ]
                }]
        };
