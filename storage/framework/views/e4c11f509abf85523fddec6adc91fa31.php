...
<div>
    <!--[if BLOCK]><![endif]--><?php if(Auth::guard('mhs')->check()): ?>
            ...
            <ul class="mt-5 h-full flex flex-col justify-between">
                <div>
                    ...
                    <a href="<?php echo e(route('dashboard-mhs')); ?>">
                        <li class="flex items-center gap-2 h-14 px-5 hover:bg-secondary hover:text-black <?php echo e(Route::is('dashboard-mhs') ? 'bg-secondary text-black' : 'text-white'); ?>">
                    ...
                    <!-- Profile -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  <?php echo e(Route::is('biodata-mhs') || Route::is('biodata-user')  ||  Route::is('edit-profile-mhs') ||  Route::is('edit-profile-user') || Route::is('change-password-mhs') || Route::is('change-password-user')  ? 'bg-secondary text-black' : 'text-white'); ?>">
                    ...
                    <!-- Type Test -->
                    <li class="flex items-center justify-between h-14 px-5 hover:bg-secondary hover:text-black  <?php echo e(Route::is('e3-schedule-mhs') || Route::is('toefl-schedule-mhs') || Route::is('e3-schedule-user') || Route::is('toefl-schedule-user') ? 'bg-secondary text-black' : 'text-white'); ?>">
                        <div class="flex items-center gap-2">
                            <div>
                    ...
                    <a href="<?php echo e(route('history-mhs')); ?>">
                        <li class="flex items-center h-14 px-5 hover:bg-secondary hover:text-black <?php echo e(Route::is('history-mhs') ? 'bg-secondary text-black' : 'text-white'); ?>">
                            <div class="flex items-center gap-2">
                                <div>
    ...
    <?php elseif(Auth::guard('user')->check()): ?>
        <aside id="sidebar" class="bg-primary w-60 h-screen pt-20 flex flex-col fixed top-0 bottom-0 -left-60 transition duration-700 ease-in-out z-10 overflow-auto">
            ...
            <div class="mt-5 w-60 h-fit flex flex-col items-center gap-2">
                <div class="w-28">
                    <img src="<?php echo e(asset('storage/' . $data->pasFoto)); ?>" alt="" width="150" height="200" class="size-fit rounded-xl">
                </div>
