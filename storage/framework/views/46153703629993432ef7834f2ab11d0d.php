...
<?php endif; ?>
            <div class="bg-white drop-shadow-lg w-full mt-1 rounded p-5 flex flex-col gap-4">
                <div class="rounded bg-blue-500 p-4 font-base text-white">
                    <p>Peserta wajib melengkapi profil terlebih dahulu di menu “Edit Profil”.</p>
                </div>
                <div class="rounded bg-red-500 p-4 font-base text-white">
                    <p>Edit profil hanya diperkenankan 1 kali.</p>
                </div>
                <div class="rounded bg-gray-300 p-4 font-base">
                    <p>Info Jadwal</p>
                </div>
                <div class="rounded bg-gray-300 p-4 font-base">
                    <p>Info Tes</p>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\Acer\Documents\Universitas Advent Indonesia\Labor\balai_bahasa\balaiBahasa\resources\views\livewire\dashboard-user.blade.php ENDPATH**/ ?>