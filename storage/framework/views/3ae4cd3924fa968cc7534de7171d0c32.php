                                ...
                                <?php if(isset($jenis[$index]) && $jenis[$index]->id_jenis_ujian == '2'): ?>
                                    <tr class="border-y">
                                        ...
                                        <td class="p-2">
                                            <?php if($kuota[$index] == 0): ?>
                                                Penuh
                                            <?php elseif($kuota[$index] > 0 && !$pesan->contains('id_ujian', $jenis[$index]->id)): ?>
                                                <button class="bg-primary text-white py-2 px-4 rounded"
                                                        wire:click="pesan(<?php echo e($jenis[$index]->id); ?>, <?php echo e($kapasitas[$index]); ?>)"
                                                        wire:confirm="Apakah Anda yakin ingin memilih jadwal ini?">Pilih</button>
                                            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Acer\Documents\Universitas Advent Indonesia\Labor\balai_bahasa\balaiBahasa\resources\views/livewire/e3-schedule-mhs.blade.php ENDPATH**/ ?>